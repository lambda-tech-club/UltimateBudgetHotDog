...
### Step 3: 受け渡し
1. 容器を輪ゴムで止める
    1. **注意: ソーセージが入ってない分が上から見えないようにする** <br> <img src="./images/IMG_2282.jpeg" height="160px"> <img src="./images/IMG_2283.jpeg" height="160px">
2. ソーセージのない空間が見えないように、低い位置でお客様に渡す
    1. 例: 名刺を差し出す時と同じぐらい低姿勢
3. 空間に注目されないような声掛けをする
   1. 例: 「ぜひ景色を楽しみながら手早くお召し上がりください。」
   2. 例: 「ステージが盛り上がっていますね。早めにお召し上がりください。」
